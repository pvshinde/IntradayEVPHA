...
+price_scen_to[4][1:4096,1:13]*pA[4]'+price_scen_to[5]*pA[5]'+price_scen_to[6]*pA[6]'+price_scen_to[7]*pA[7]'+price_scen_to[8]*pA[8]'+price_scen_to[9]*pA[9]'+price_scen_to[10]*pA[10]'))+
...
price_reg_from[8]*pD[8]'+price_reg_from[9]*pD[9]'+price_reg_from[10]*pD[10]'-(price_reg_to[1]*pU[1]'+ price_reg_to[2]*pU[2]'+ price_reg_to[3]*pU[3]'+ price_reg_to[4]*pU[4]'+price_reg_to[5]*pU[5]'
+price_reg_to[6]*pU[6]'+price_reg_to[7]*pU[7]'+
